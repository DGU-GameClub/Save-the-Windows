...
public class TowerBullet : MonoBehaviour
{
    ...
    {
        if ((collision.CompareTag("Enemy") || collision.CompareTag("Boss")) && ((AttackEnemy != null && AttackEnemy.Equals(collision.gameObject)) || Tower.GetComponent<TowerUnit>().UnitName.Equals("웨일")))
        {
